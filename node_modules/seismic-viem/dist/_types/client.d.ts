...
import { EncryptionActions } from './actions/encryption.ts';
import type { ShieldedPublicActions } from './actions/public.ts';
import type { ShieldedWalletActions } from './actions/wallet.ts';
/**
 ...
 */
export type ShieldedWalletClient<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account = Account, TRpcSchema extends RpcSchema | undefined = undefined> = Client<transport, chain, account, RpcSchema, PublicActions<transport, chain, account> & WalletActions<chain, account> & EncryptionActions & ShieldedPublicActions<TRpcSchema> & ShieldedWalletActions<chain, account>>;
