...
contract SERC20 is ISERC20 {
    ...
    function totalSupply() public view returns (uint256) {
        ...
        // shielded value
        require(
            _balances[sender] > suint256(0),
            "must have balance in order to view total supply"
        );
    ...
    function allowance(
        ...
        saddress sender = saddress(msg.sender);
        require(
            sender == owner || sender == spender,
            "not authorized to view allowance"
        );
